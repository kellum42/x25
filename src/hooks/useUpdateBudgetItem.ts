...
export type UseUpdateBudgetItemType = {
...
export const useUpdateBudgetItem = (defaults: Record<string, string|undefined> = {}): UseUpdateBudgetItemType => {
  ...
  return { fields, loading, error, screen, next, back, update, save };
};